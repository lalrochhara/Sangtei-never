...
PM_START_TEXT = """
Hay There! [👋](https://i.ibb.co/6yqvTcN/oie-oie-glitters.gif), My Name Is  *Sangtei 👸*. 
...
PM_IMG = "https://i.ibb.co/6yqvTcN/oie-oie-glitters.gif"


HELP_STRINGS = f"""
*⚊❮❮❮『 Sangtei  HΞLP MΞИU 』❯❯❯⚊*

Hay !👋 I'm  Sangtei [👸](https://i.ibb.co/6yqvTcN/oie-oie-glitters.gif)
...
BUTTONS = [
    [
        InlineKeyboardButton(
            text="Group ah hmang rawh", url="http://t.me/SangteiBot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="Bot Updates", url=f"https://t.me/SangteiUpdates"),
        InlineKeyboardButton(
            text="Support", url=f"https://t.me/SangteiSupport"
        ),
    ],
    [
        InlineKeyboardButton(text="Thurawn pekna", url=f"https://t.me/SangteiFeedBack"),
        InlineKeyboardButton(
            text="Keimahni", callback_data="aboutmanu_"
        ),
    ],
    [
        InlineKeyboardButton(text="Tanpuina & Hmandan", url=f"http://t.me/SangteiBot?start=help"),
    ],
]
IMPORTED = {}
MIGRATEABLE = []
...
def Sangtei_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Than send `/admincache@SangteiBot` in that chat to refresh admin list in My database.\n"
        ...
        query.message.edit_text(
            ...
            f"\nCongragulations, @SangteiBot now ready to manage your group."
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="🖲ᴇʟɪɴᴀ sᴜᴘᴘᴏʀᴛ🖲", url="https://t.me/SangteiSupport"),
                    InlineKeyboardButton(text="📰ᴇʟɪɴᴀ Uᴘᴅᴀᴛᴇs📰", url="https://t.me/SangteiUpdates"),
                 ],
                 [
                    InlineKeyboardButton(text="🔙 ʙᴀᴄᴋ", callback_data="aboutmanu_"),
        ...
        query.message.edit_text(
            text=f"* CREDITS  FOR @SangteiBot  DEV *\n"
            f"\n Here you can find information about the bots I coded and the people who helped me create ELINA"
            f"\n Special credits [hirunaofficial](https://github.com/hirunaofficial/Telegram-Group-Management-Bot-Sangtei)  & [Anikivictor](https://github.com/Damantha126/The-Anki-Vector)"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Sangtei", url="https://t.me/sltechzoneofficial"),
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Sangtei_about_callback, pattern=r"aboutmanu_"
    )
